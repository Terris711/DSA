...
def usage():
    ...
    print("           m - mergesort")
    print("           q - quicksort")
    print("           M - median of 3 pivots quick sort")
    print("           Q - 3-way quick sort")
    print("        y is one of")
...
def doSort(n, sortType, arrayType):
        ...
        if sortType == "b":
            A = DSAsorts.bubbleSort(A)
            print(A)
        elif sortType == "s":
            A = DSAsorts.selectionSort(A)
            print(A)
        elif sortType == "i":
            A =  DSAsorts.insertionSort(A)
            print(A)
        elif sortType == "m":
            A = DSAsorts.mergeSort(A)
            print(A)
        elif sortType == "q":
            A = DSAsorts.quickSort(A)
            print(A)
        elif sortType == "M":
            A = DSAsorts.quickSort3Median(A)
            print(A)
        elif sortType == "Q":
            A = DSAsorts.quickSort3way(A)
            print(A)
